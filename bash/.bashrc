...
export GOPATH PATH DYLD_LIBRARY_PATH LIBRARY_PATH MANPATH DEV_ROOT PS1 EDITOR FZF_DEFAULT_COMMAND VISUAL HISTSIZE HISTFILESIZE RUST_SRC_PATH BASH_SILENCE_DEPRECATION_WARNING DENO_INSTALL DISPLAY XDG_CONFIG_HOME
